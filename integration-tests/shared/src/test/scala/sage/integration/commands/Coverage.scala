...
object Coverage {
  ...
  val skipped: Map[String, String] = Map(
    ...
    "READONLY"             -> "deferred: v1 routes reads to the primary; replica-read scaling is not yet supported (issue #80)",
    "READWRITE"            -> "deferred: v1 routes reads to the primary; replica-read scaling is not yet supported (issue #80)",
